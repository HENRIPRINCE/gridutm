    ...
    def Executer(self):
        ...
        if repEto != '':
            ...
            if self.radio_pt.isChecked():
                ...
                schema = {
                    'geometry':'Point',
                    'properties':[('id','int'),('distance','str'),('y_x','str'),('x','int'),('y','int')]
                }
                pointShp = fiona.open(repEto, mode='w', driver='ESRI Shapefile', schema = schema, crs = "EPSG:32738")
